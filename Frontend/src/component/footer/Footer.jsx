  ...
  return (
    <footer className="footer">
      <div className="newsletter">
        <div>
          <h3>SUBSCRIBE FOR EXCLUSIVE DEALS & TRENDS</h3>
        </div>
      ...
      <div className="footer-content">
        <div className="footer-section footer-logo">
          <div className="footer-logo-container">
            ...
            <h2>CHARM EMPORIUM</h2>
          </div>

          <p>India Accelerator Noida 201301 UP, India</p>
          <p>marketing@entrepreneurshipnetwork.net</p>
        </div>
        ...
        <div className="footer-links">
          ...
          <div className="footer-section">
            ...
            <ul>
              <li>
                <Link to="/winterwear">Clothes</Link>
              </li>
              <li>
                <Link to="/lipstick">Makeup</Link>
              </li>
              <li>
                <Link to="/heels">Shoes</Link>
              </li>
            </ul>
          </div>
          <div className="footer-section">
      ...
      <div className="footer-bottom">
        <p>
          &copy; 2025 CHARM EMPORIUM. Designed with elegance, developed with
          dedication—by the Charm Emporium Team.
        </p>
      </div>
    </footer>
  );
